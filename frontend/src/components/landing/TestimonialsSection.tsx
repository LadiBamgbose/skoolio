...
const testimonials: Testimonial[] = [
  {
    ...
    quote: 'Skoolio cut my quiz creation time from 2 hours to just 10 minutes. I can now focus on teaching instead of paperwork!',
  ...
  },
  {
    ...
    quote: 'The AI generates perfectly aligned questions in seconds. What used to take me an entire weekend now takes 15 minutes.',
  ...
  },
  {
    ...
    quote: 'I love how quick and easy it is to create engaging quizzes. More time for my students, less time on admin work.',
  ...
  },
  {
    ...
    quote: 'Game-changing tool! I can create multiple quiz variations instantly. My students are more engaged and I have my weekends back.',
  ...
  },
  {
    ...
    quote: 'This saved me 15 hours a week on quiz prep. The quality is amazing and my students love the format!',
  ...
  },
  {
    ...
    quote: 'Finally, a tool that understands what teachers need. Simple, fast, and incredibly effective.',
  ...
  },
  {
    ...
    quote: 'Creating quizzes used to be my least favorite task. Now it takes minutes and I actually enjoy it!',
  ...
  },
  {
    ...
    quote: 'Amazing time-saver! I can create differentiated quizzes for all my classes in no time.',
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        >
          <h2 
            ...
            style={{
              backgroundImage: "linear-gradient(135deg, #3b82f6, #06b6d4, #2563eb)",
